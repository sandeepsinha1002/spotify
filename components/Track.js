...
export default function Track({track,chooseTrack}) {
  ...
  return (
    <div className='flex items-center justify-between  space-x-10 cursor-default hover:bg-white/10 py-2 px-4 rounded-lg group transition ease-out '>
        <div className='flex items-center'>
            ...
            />
            <div>
            <h4 className='text-white text-sm truncate font-semibold w-[450px]'>
                {track.title}
            </h4>
        ...
        <div className='md:ml-auto flex items-center space-x-2.5'>
            ...
            <div className='flex items-center rounded-full border-2 border-[#262626] w-[85px] h-10 relative cursor-pointer group-hover:border-white/40'>
                ...
                {track.uri===playingTrack.uri && play ? (
                    ...
                    <div className='h-10 w-10 rounded-full border border-white/60 flex items-center justify-center absolute -right-0.5 hover:bg-[#15883e] icon hover:scale-110' onClick={handlePLay}>
